...
\multicolumn{3}{l}{ Test Plan {\bf LVV-P59: Camera Rotator Functional Re-verification }} & Completed \\\hline
  ...
  {\bf \footnotesize test case} & {\bf \footnotesize status} & {\bf \footnotesize comment} & {\bf \footnotesize issues} \\\toprule
    ...
    \begin{minipage}[]{9cm}
    \smallskip
    Overall, the test campaign for the Camera Rotator Software Functional
Re-verification was seen as an ``Initial Pass'' as this test will be
repeated again (with a Camera mass). All the necessary test steps met
the expected results and were labeled as ``Initial Pass''. The steps
that were not executed were not necessary to verify the software
functionality and will be tested in a future test campaign.~
    \medskip
    \end{minipage}
    &
    \\\hline
    ...
    \begin{minipage}[]{9cm}
    \smallskip
    Overall, the test campaign for the Camera Hardware Functional
Re-verification was seen as a ``Fail'' as not all test steps were
successful. The recommended improvement for this test case is to update
LSST's CSC software to allow for the software limits to be adjusted. For
the complete test results, see~\textbf{LSST Rotator Acceptance Test
Results}~in~\url{https://docushare.lsstcorp.org/docushare/dsweb/View/Collection-8902/Document-35429}~.
    \medskip
    \end{minipage}
    &
...
Overall, the result of the test campaign is:
FAIL.\\[2\baselineskip]Although the majority of the Camera Rotator
Software Functional Re-verification test steps passed, some steps were
left unexecuted and will be tested during the final testing campaign of
the Camera Rotator.\\
The Hardware Functional Re-verification test also had one unexecuted
test step, as well as one failed test step, that will need to be
performed in the future (see Recommended Improvements).
...
\tightlist
\item
  Update the LSST CSC software to allow for the ability to adjust the
  Camera Rotator Software Limits
\end{itemize}
...
Final comment:\\Overall, the test campaign for the Camera Rotator Software Functional
Re-verification was seen as an ``Initial Pass'' as this test will be
repeated again (with a Camera mass). All the necessary test steps met
the expected results and were labeled as ``Initial Pass''. The steps
that were not executed were not necessary to verify the software
...
Final comment:\\Overall, the test campaign for the Camera Hardware Functional
Re-verification was seen as a ``Fail'' as not all test steps were
successful. The recommended improvement for this test case is to update
LSST's CSC software to allow for the software limits to be adjusted. For
the complete test results, see~\textbf{LSST Rotator Acceptance Test
...
\end{minipage} \\ \cdashline{2-2}
 ...
 & Actual Result \\
 & \begin{minipage}[t]{15cm}{\footnotesize
The Camera Rotator was verified to reach the required acceleration. See
videos ``20200129\_122733.mp4'' and ``20200129\_123530.mp4''
in~\url{https://docushare.lsstcorp.org/docushare/dsweb/View/Collection-8902}~
