...
shipment from the vendors facility to the Summit, as defined in LTS-206
and LTS-160. This test campaign will only exercise the functionality
...
hardware from the vendor's facility to the Summit, as defined in LTS-206
and LTS-160. This test case will only exercise the functionality that
...
vendors facility to the Summit, as defined in LTS-206. This test case
